...
- Full Unity project source, assets, and a Windows build
- User Training Manual (visitor-facing interaction guide)
- Developer Training Manual (architecture overview, code documentation, test plans, and a guide for adding new exhibits)
